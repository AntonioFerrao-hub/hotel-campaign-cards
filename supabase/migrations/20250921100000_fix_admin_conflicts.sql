-- Fix admin conflicts and permission issues
-- Migration: 20250921100000_fix_admin_conflicts.sql

-- ========================================
-- PROBLEMA 1: FUNÇÃO ensure_user_profile CRIA ADMINISTRADORES AUTOMATICAMENTE
-- ========================================

-- Modificar a função para criar usuários com role 'user' por padrão
...
-- Função para sincronizar dados entre auth.users e profiles
...
-- Função para auditar e corrigir múltiplos administradores
...
-- Recriar políticas RLS de forma consistente
